# MySQL, PHPMyAdmin and Node.js (ready for Express development) saurabh 
...
### Whats provided in these scaffolding files?
  ...
  * A package.json file that  pull in the node.js libraries required and start your app as needed.
